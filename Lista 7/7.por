...
{
/*
 * 7) Faça um algoritmo que leia uma matriz 5x5 de números. Calcule e mostre o produto das linhas ímpares da
matriz. Utilize uma função para o cálculo do produt
 */
	...
	funcao inteiro somaImpar(inteiro mat [] []) {
		inteiro l, c, soma = 0
		para(l=0;l<TAMLINHA;l++){
			para(c=0;c<TAMCOLUNA;c++){
				se (mat[l][c]%2 == 1) {
